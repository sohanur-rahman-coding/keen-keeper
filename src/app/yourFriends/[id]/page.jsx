...
const promiseFriends = async () => {
  const res = await fetch("https://keen-keeper-y5gy.vercel.app/data.json",{cache:'no-store'});
    ...
    <div className="w-11/12 mx-auto justify-center flex gap-8">
      <div className="left my-12">
        ...
        <div className="space-y-2 my-4 flex flex-col">
          ...
          <button className="btn bg-white btn-wide max-w-87.5">Archive</button>
          <button className="btn bg-white btn-wide max-w-87.5 text-red-500">Delete</button>
        </div>
      </div>
